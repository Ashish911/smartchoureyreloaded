...
const UserChoureyTwoDetail = () => {
    ...
    useEffect(() => {
        if (siteId != undefined) {
            dispatch(getChoureyTwoDetail(id, siteId))
        }
    }, [siteId])
    ...
    return (
        <>
            ...
            <PhotoDetail data={data} user={true} type={'choureyOne'} id={choureyTwoDetail?.choureyTwoInfo?.choureyTwoId}/>
            <VideoDetail data={videoData} user={true} type={'choureyOne'} id={choureyTwoDetail?.choureyTwoInfo?.choureyTwoId}/>
            <PdfDetail data={pdfData} user={true} type={'choureyOne'} id={choureyTwoDetail?.choureyTwoInfo?.choureyTwoId}/>
        </>
    )
}

export default UserChoureyTwoDetail